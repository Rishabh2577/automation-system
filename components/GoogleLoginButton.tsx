      ...
      <div className="max-w-md w-full glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl text-center space-y-5 sm:space-y-6">
        ...
        <div className="pt-2 sm:pt-4 flex justify-center">
          ...
          <div className="relative inline-block">
            ...
            <div className="absolute inset-0 flex items-center justify-center gap-3 px-8 py-3 rounded-full bg-gradient-to-r from-pink-200 to-pink-300 hover:brightness-95 transition-all duration-200 shadow-md pointer-events-none">
              {/* Google G Icon */}
              ...
              <span className="text-gray-900 font-semibold text-base whitespace-nowrap">Sign in</span>
            </div>
          </div>
        </div>
